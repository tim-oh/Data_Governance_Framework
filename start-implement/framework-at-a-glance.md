...
This report proposes a Framework with five levels of detail:
...
|--------|----------------|
| **1. Management** | Planning · Acquisition · Processing · Analysis · Use/sharing · Archiving |
| **2. Quality** | Completeness · Accuracy · Currency · Consistency · Validity · Uniqueness |
| **3. Access** | Internal access · External access · Open data · Cross-cutting issues |
| **4. Security** | Technical · Organisational · Physical · People |

## Key roles

- **Data governance council (GC):** A body comprised of senior representatives from the main stakeholders that provides suitable oversight. The role of the council is to oversee the sector's operational performance, to propose, evaluate and sign off on policy, and to coordinate the activities of sector members.

- **Data administrator (DA):** The policy maker who assumes a policy design, coordination, and digital service execution role for the social protection database.

- **Programme administrator (PA):** The institution that provides a given social protection programme, assuming an operational and policy-implementation role.

- **Data collector (DC):** The entity responsible for the collection of primary data during personal or household interviews.

- **Data provider (DP):** Institutions that create relevant information as part of their regular operations, such as demographic data from civil registration, or asset ownership from land and vehicle registries.

- **IT services (IT):** The technical service provider for digital infrastructure.
